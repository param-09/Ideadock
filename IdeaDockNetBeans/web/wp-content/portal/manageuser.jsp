<%-- 
    Document   : manageuser
    Created on : Mar 29, 2018, 9:31:00 PM
    Author     : ARPIT-PATEL
--%>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<%=request.getContextPath()%>/Controller?actioncode=deleteuser&user_id=<%=roleObj.getUser_id()%>" class="btn btn-danger">Delete</a>
                                                 <% if(roleObj.getActive_flag() == 0){%>
                                                <a href="<%=request.getContextPath()%>/Controller?actioncode=blockuser&user_id=<%=roleObj.getUser_id()%>" class="btn btn-info"><i class="fa fa-ban"></i>Block</a>
                                                    <% } if(roleObj.getActive_flag() == 1){%>
                                                <a href="<%=request.getContextPath()%>/Controller?actioncode=unblockuser&user_id=<%=roleObj.getUser_id()%>" class="btn btn-success"><i class="fa fa-unlock-alt"></i>Unblock</a>
                                                    <% }%>
                                            </td>
